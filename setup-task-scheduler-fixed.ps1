...
$scriptPath = "c:\Users\Admin\Downloads\linear-reporting\linear-reporting"
...
# Register the task
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Principal $principal -Description "Automatically starts the Linear Report Scheduler which sends daily email reports at 5:00 PM"
